...
Due Friday, April 15th by 5 pm (UK local time). Please download the attached zip file for a template notebook and a complete description of the tasks in the README, which also includes a description of the dataset.
